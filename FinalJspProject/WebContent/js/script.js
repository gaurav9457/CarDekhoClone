...
var alertBoxLogoutParent=document.getElementById("alertBoxLogoutParent");
var logBtnName;
window.onclick = function (e) {

    if (e.target == display || e.target == displayRegister || e.target == tablePage || e.target == alertBoxLogoutParent) {
...
function LoginObjMain() {
	...
	function cancel(){
	  ...
	  document.getElementById("alertBoxLogoutParent").style.display = 'none';
	}
	...
	function loginValidation(e){
	 ...
	 function loginAuth(btn) {
        ...
        if (Username == inpUsername && password == inpPassword) {
            ...
            document.getElementById("RegisterLink").innerHTML ="All USERS";
           
			 document.getElementById("profileIcon").style.display="block";
			// document.getElementById("loginName").innerHTML =`<sup>Welcome ${inpUsername}</sup>`;
        }
